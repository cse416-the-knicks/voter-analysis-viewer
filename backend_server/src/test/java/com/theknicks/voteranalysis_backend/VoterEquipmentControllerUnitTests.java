...
/**
 * NOTE(jerry): This is not a MvcMockTest, because the setup for that is *really* complicated and
 * there's already enough testing for this part (which is really more of a service test.)
 */
@SpringBootTest
public class VoterEquipmentControllerUnitTests {
    ...
    modelsList =
        List.of(
            new VotingEquipmentModel(
                ...
                Optional.of(2012),
                Optional.empty(),
                Optional.of("Linux 4.4"),
                Optional.of("5.2.3"),
                Optional.of(true),
                Optional.of("VVSG 2005"),
                Optional.empty()),
            new VotingEquipmentModel(
                "CivicVote",
                ...
                Optional.of(2021),
                Optional.empty(),
                Optional.of("Android 11"),
                Optional.of("1.0.2"),
                Optional.of(true),
                Optional.of("VVSG 2021"),
                Optional.empty()),
            new VotingEquipmentModel(
                "DemocracyWorks",
                "Ballot Marking Device",
                ...
                Optional.of(2006),
                Optional.of(2012),
                Optional.of("Custom RTOS"),
                Optional.of("0.9"),
                Optional.of(false),
                Optional.of("VVSG 2002"),
                Optional.of("Lacked paper trail")),
            new VotingEquipmentModel(
                "DemocracyWorks",
                "Optical Scan",
                "DW Scan Pro",
            ...
            new VotingEquipmentModel(
                ...
                Optional.of(1998),
                Optional.of(2005),
                Optional.of("Windows 95"),
                Optional.of("1.0.3"),
                Optional.of(false),
                Optional.of("VVSG 2002"),
                Optional.of("Obsolete crypto libraries")),
            new VotingEquipmentModel(
                "ElectroVote",
                "DRE",
                "EV-500",
                ...
                Optional.of(2002),
                Optional.of(2010),
                Optional.of("Windows XP"),
                Optional.of("2.5"),
                Optional.of(false),
                Optional.of("VVSG 2002"),
                Optional.of("Unpatched OS vulnerabilities")),
            new VotingEquipmentModel(
                "ElectroVote",
                "Hybrid",
                "EV-Hybrid 1",
            ...
            new VotingEquipmentModel(
                ...
                Optional.of(2004),
                Optional.of(2011),
                Optional.of("Windows CE"),
                Optional.of("1.2"),
                Optional.of(false),
                Optional.of("VVSG 2002"),
                Optional.of("Lost ballot audit data")),
            new VotingEquipmentModel(
                "SecureBallot",
                "Optical Scan",
                "ScanMaster Portable",
            ...
            new VotingEquipmentModel(
                ...
                Optional.of(2019),
                Optional.empty(),
                Optional.of("Android 9"),
                Optional.of("7.0.1"),
                Optional.of(true),
                Optional.of("VVSG 2005"),
                Optional.of("Potential supply chain issues")),
            new VotingEquipmentModel(
                "VoteSys",
                "Optical Scan",
                "ScanLite 100",
  ...
  void VoterEquipmentController_GetVotingEquipmentByManufacturer_RealManufacturer(
      String targetManufacturer, int expectedManufacturerCount) {
    // Act
  ...
  @ParameterizedTest
  @CsvSource({"Optical Scan, 6", "DRE, 3", "Hybrid, 3", "Ballot Marking Device, 3"})
  void VoterEquipmentController_GetVotingEquipmentByType_Success(
      String targetType, int expectedTypeCount) {
    // Act
