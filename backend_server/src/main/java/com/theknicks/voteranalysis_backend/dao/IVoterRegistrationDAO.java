...
import java.util.*;
/**
 * This is the data access object interface for
 * the detailed voter registration data.
 */
public interface IVoterRegistrationDAO {
    /**
     * This access point is meant to return all the rows for detailed
     * voter registration information.
     *
     * The parameters are present to allow for filtering (optionally) by
     * either the following:
     *      - None
     *      - State
     *      - State + County/RegionFips
     * Providing only a county without a state will result in an empty list.
     *
