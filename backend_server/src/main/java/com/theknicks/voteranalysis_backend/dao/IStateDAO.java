...
public interface IStateDAO {
     ...
     */
    List<ProvisionalBallotStatisticsModel> getProvisionBallotRows(String fipsCode, int year, boolean aggregated);
     ...
     */
    Optional<ProvisionalBallotStatisticsModel> getProvisionBallotRowByCounty(String fipsCode, String countyCode, int year);
     ...
     */
    List<VoterRegistrationStatisticsModel> getVoterRegistrationRows(String fipsCode, int year, boolean aggregated);
     ...
     */
    Optional<VoterRegistrationStatisticsModel> getVoterRegistrationRowByCounty(String fipsCode, String countyCode, int year);
     ...
     */
    List<PollbookDeletionStatisticsModel> getPollbookDeletionRows(String fipsCode, int year, boolean aggregated);
     ...
     */
    Optional<PollbookDeletionStatisticsModel> getPollbookDeletionRowByCounty(String fipsCode, String countyCode, int year);
     ...
     */
    List<MailBallotRejectionStatisticsModel> getMailBallotRejectionRows(String fipsCode, int year, boolean aggregated);
     ...
     */
    Optional<MailBallotRejectionStatisticsModel> getMailBallotRejectionRowByCounty(String fipsCode, String countyCode, int year);
