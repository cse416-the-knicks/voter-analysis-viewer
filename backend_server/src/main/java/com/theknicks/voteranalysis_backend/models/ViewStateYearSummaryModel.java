...
/**
 * "state_id" "state_code" "state_name" "year" "active_registered" "inactive_registered"
 * "total_registered" "total_ballots_cast" "early_voting_total" "ballots_by_mail" "prov_cast"
 * "active_voter_rate" "inactive_voter_rate" "turnout_rate" "early_share" "mail_share" 1 "AL"
 * "Alabama" 2024 3466606 401434 3868040 126018 13355 0.89621772267091343419 0.10378227732908656581
 * 0.03257929080361113122
 */
