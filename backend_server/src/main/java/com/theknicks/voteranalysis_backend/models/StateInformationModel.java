...
/**
 * This is the prepared version of the data in the states table,
 * and the version of data that is given to calling clients.
 */
public record StateInformationModel(
    ...
    public static StateInformationModel fromRaw(
	StateInformationDataRowModel rowModel) {
