...
- [ ] **GUI-13. Display US voting equipment summary (required)**
...
- [ ] **GUI-20. Display 2024 EAVS voting regions when a state is selected (required) (SD)**
...
- [ ✅ ] **Prepro-3. Populate DB with EAVS data (2016-2024) (required)**
- [ ✅ ] **Prepro-4. Add geographic data to DB (required)**
- [ ] **Prepro-5. Develop measure of missing EAVS data (required)**
- [ ] **Prepro-6. Develop measure of voting equipment quality (required)**
- [ ] **Prepro-7. Analyze voter registration data for one state (required)**
- [ ] **Prepro-8. Analyze voter registration data using automated service (preferred)**
...
- [ ] **Prepro-12. Add CVAP (citizen voting-age population) data to DB (required)**
...
- [ ✅ ] **Server-2. Generate JSON response (required)**
...
- **Required = must-have**
- **Preferred = should-have, aim for as many as feasible**
