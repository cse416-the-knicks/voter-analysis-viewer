...
function NotImplementedYet({ hook }: NotImplementedYetProperties) {
  const handleClose = () => {
    hook[1](false);
  };
  return (
      ...
      <Dialog sx={{ zIndex: 9999 }} open={hook[0]} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <br />
            <br />
            We are not ready to show this yet! It is either not designed yet or we haven't though of it yet!
            <br />
          </DialogContentText>
        </DialogContent>
        <DialogActions>
