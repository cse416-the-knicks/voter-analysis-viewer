import { getElectionResultsSummary, getDetailedVotingEquipmentUsage, getMailBallotRejections, getCVAPStatisticsData, getVoterRegistrationCounts } from "../../../api/client";
