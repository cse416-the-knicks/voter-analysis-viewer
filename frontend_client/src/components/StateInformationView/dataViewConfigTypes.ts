...
export type { StateInformationViewDataConfiguration, StateInformationViewSimpleFactView, StateInformationViewOverlayView, DataFact };

export { STATE_INFORMATION_VIEW_TYPE_OVERLAY, STATE_INFORMATION_VIEW_TYPE_SIMPLE };
